...
namespace Tayx.Graphy.Resim {
    public class G_ResimManager : MonoBehaviour, IMovable, IModifiableState {
        #region Variables -> Serialized Private

        [SerializeField] private GameObject m_resimGraphGameObject = null;
        ...
        private G_ResimGraph m_resimGraph = null;
        private G_ResimMonitor m_resimMonitor = null;
        // private                     G_ResimText                   m_fpsText = null;
        ...
        public void UpdateParameters() {
            ...
            m_resimGraph.UpdateParameters();
            m_resimMonitor.UpdateParameters();
            // m_fpsText       .UpdateParameters();

            SetState(m_graphyManager.ResimModuleState);
        }
        ...
        private void Init() {
            ...
            m_resimGraph = GetComponent<G_ResimGraph>();
        ...
        private void SetGraphActive(bool active) {
            m_resimGraph.enabled = active;
            m_resimGraphGameObject.SetActive(active);
        }
