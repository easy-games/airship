    ...
    public abstract partial class ManagedObjects
    {
        ...
        protected void WriteChangedTransformProperties(NetworkObject nob, bool sceneObject, bool nested, Writer headerWriter)
        {
            ...
            else
            {
                ...
                if (newNob == null) {
                    Debug.LogError("Unable to spawn new network object for " + nob.gameObject.name + ". Make sure all network prefabs are in Assets/Bundles/Shared/Resources/NetworkPrefabCollection.asset");
                }
