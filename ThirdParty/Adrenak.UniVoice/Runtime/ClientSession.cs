...
namespace Adrenak.UniVoice {
    ...
    public class ClientSession<T> : IDisposable {
        ...
        public ClientSession(IAudioClient<T> client, IAudioInput input, IAudioOutputFactory<T> outputFactory) {
            Client = client;
            Input = input;
