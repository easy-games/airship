...
namespace Code.Platform.Server
{
    ...
    public class DataStoreServiceBackend
    {
        ...
        {
            return await InternalHttpManager.GetAsync($"{AirshipUrl.DataStoreService}/data/key/{key}");
        }
        ...
        {
            return await InternalHttpManager.DeleteAsync($"{AirshipUrl.DataStoreService}/data/key/{key}");
        }
    }
}