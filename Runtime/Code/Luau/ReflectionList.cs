...
namespace Luau {
    public static class ReflectionList {
        ...
        private static readonly Dictionary<Type, LuauContext> AllowedTypes = new() {
            ...
            [typeof(UnityEngine.UI.GridLayoutGroup)] = LuauContextAll,
            ...
            [typeof(UnityEngine.UI.CanvasScaler)] = LuauContextAll,
            [typeof(UnityEngine.UI.Toggle)] = LuauContextAll,
            [typeof(UnityEngine.UI.Mask)] = LuauContextAll,
            [typeof(UnityEngine.UI.ContentSizeFitter)] = LuauContextAll,
            [typeof(UnityEngine.UI.AspectRatioFitter)] = LuauContextAll,
