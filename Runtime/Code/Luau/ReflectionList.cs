...
namespace Luau {
    public static class ReflectionList {
        ...
        private static readonly Dictionary<Type, LuauContext> AllowedTypes = new() {
            ...
            [typeof(TMP_TextInfo)] = LuauContextAll,
            [typeof(TMP_CharacterInfo)] = LuauContextAll,
            [typeof(TMP_WordInfo)] = LuauContextAll,
            [typeof(TMP_LineInfo)] = LuauContextAll,
            [typeof(TMP_PageInfo)] = LuauContextAll,    
            [typeof(TMP_MeshInfo)] = LuauContextAll,
            [typeof(TMP_SpriteInfo)] = LuauContextAll,
            [typeof(TMP_LinkInfo)] = LuauContextAll,
