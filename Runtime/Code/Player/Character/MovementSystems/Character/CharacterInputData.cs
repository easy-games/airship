...
namespace Code.Player.Character.NetworkedMovement
{
	...
	/// </summary>
	public class CharacterInputData : InputCommand, IEquatable<CharacterInputData>
	{
		...
		public CharacterInputData(int commandNumber, Vector3 moveDir, bool jump, bool crouch, bool sprint, Vector3 lookVector,
			BinaryBlob customData)
		{
		...
		public bool Equals(CharacterInputData other)
		{
