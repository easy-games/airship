...
namespace ElRaccoone.Tweens {
    public static class OffsetMaxTween {
        public static Tween<Vector2> TweenOffsetMax(this Component self, Vector2 to, float duration) =>
            Tween<Vector2>.Add<Driver>(self).Finalize(to, duration);

        public static Tween<Vector2> TweenOffsetMax(this GameObject self, Vector2 to, float duration) =>
            Tween<Vector2>.Add<Driver>(self).Finalize(to, duration);
